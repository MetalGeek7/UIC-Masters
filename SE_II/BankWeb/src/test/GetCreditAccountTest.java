...
public class GetCreditAccountTest {
	...
	static {
		...
		database = "group2db_creditaccount";
	}
	...
	public void checkGetAccount() throws Exception {
		...
		IDataSet dataset = new FlatXmlDataSet(new FileInputStream(
				"testData/GetCreditAccount.xml")); // Check dbDump.xml for help
		...
		System.out.println("---");
		Customer abhishekKanchan = Customer.authenticate("akanch4", "5f4dcc3b5aa765d61d8327deb882cf99");
//		System.out.println(abhishekKanchan.getUserName());
