 ...
 * Note:
 * 
 * This is how this test case is designed and should be thought of:
 * 
 * This class should be used only for 1 @Test for clarity
 * 
 * The variable `database` must hold the database name that will be used for testing
 * This new database is created before the test execution and dropped after the test execution
 * 
 * There are two functions:
 * 1. createSchema
 *    This function creates the new database & creates all the tables.
 *    This function can be copied as it is for other Test Classes you will create
 * 
 * 2. cleanUp
 *    This function will drop the `new` database
 */
...
public class LoginTest {
	...
	public void checkLogin() throws Exception {
		...
		Customer customer = Customer.authenticate("apatil4", "password");
		
		assertNotNull(customer);
		// Your test code ends
		
		
		Reporting.out.println("Customer is : " + customer);
		connection.close();
