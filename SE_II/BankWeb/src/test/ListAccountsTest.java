...
public class ListAccountsTest {
	...
	public void checkGetAccount() throws Exception {
		...
		IDataSet dataset = new FlatXmlDataSet(new FileInputStream(
				"testData/ListAccounts.xml")); // Check dbDump.xml for help
		...
		for (int accountID : accountIDs) {
			...
			Reporting.out.println("AccountID: "+account.getAccountID());
		}
		// Your test code ends
