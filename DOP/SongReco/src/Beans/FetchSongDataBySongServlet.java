...
/**
 * Servlet implementation class FetchSongDataBySongServlet
 */
@WebServlet("/FetchSongDataBySongServlet")
public class FetchSongDataBySongServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public FetchSongDataBySongServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("here");
			try {
				...
				List<SongBean> list=ruleInvoker.fetchSongDataForSong(ksession, song_id, "SongData");
