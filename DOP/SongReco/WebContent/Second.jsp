...
<td width="500"> <%=Users.user.getUserName() %> </td>
...
<a href="<%=request.getContextPath()%>/DisplaySongsServlet">Songs</a>
<a href="<%=request.getContextPath()%>/DisplayAlbumsServlet">Albums</a>
<a href="<%=request.getContextPath()%>/DisplayArtistsServlet">Artists</a>
</body>
</html>