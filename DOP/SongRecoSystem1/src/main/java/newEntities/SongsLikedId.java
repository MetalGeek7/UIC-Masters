...
/**
 * SongsLikedId generated by hbm2java
 */
@Embeddable
public class SongsLikedId implements java.io.Serializable {
	...
	public SongsLikedId(String userId, String songId) {
		this.userId = userId;
		this.songId = songId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SongsLikedId))
			return false;
		SongsLikedId castOther = (SongsLikedId) other;
