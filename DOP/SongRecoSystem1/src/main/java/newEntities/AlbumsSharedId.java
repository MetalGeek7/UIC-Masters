...
/**
 * AlbumsSharedId generated by hbm2java
 */
@Embeddable
public class AlbumsSharedId implements java.io.Serializable {

	private String userId;
	private String albumId;

	public AlbumsSharedId() {
	}

	public AlbumsSharedId(String userId, String albumId) {
		this.userId = userId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlbumsSharedId))
			return false;
		AlbumsSharedId castOther = (AlbumsSharedId) other;
