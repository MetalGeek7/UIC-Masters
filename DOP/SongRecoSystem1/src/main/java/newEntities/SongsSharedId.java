...
/**
 * SongsSharedId generated by hbm2java
 */
@Embeddable
public class SongsSharedId implements java.io.Serializable {

	private String userId;
	private String songId;

	public SongsSharedId() {
	}

	public SongsSharedId(String userId, String songId) {
		this.userId = userId;
		this.songId = songId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SongsSharedId))
			return false;
		SongsSharedId castOther = (SongsSharedId) other;
